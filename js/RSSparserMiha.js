...
$.get('//www.moonwards.com/feed/rss.xml', function (data) { //you'll change the URL here to the URL of your XML file
 ...
 if (atom_no <= display_no) { //if you want reversed order, put here "if (atom_no > $(data).find("item").length - display_no)"
